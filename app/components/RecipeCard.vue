...
<template>
  <div class="flex flex-col shadow rounded-md">
          <NuxtImg :src=recipe.image sizes="xs:100vw sm:50vw lg:400px" densities="x1" format="webp" alt="" class="rounded-t-md" />
          <div class="flex flex-col py-6 px-4 flex-1">
            ...
            <BaseBtn :to="`/recipes/${recipe.id}`" label="View Recipe"/>
          </div>
        </div>
</template>
